            ...
            node.members.forEach(function (member) {
                ...
                if (lastToken) {
                    ...
                    if (style == options.style)
                        return;
                    ctx.addFailureAtNode(lastToken, "Interface member must end with \"" + options.style + "\" instead of \"" + style + "\"", Lint.Replacement.replaceNode(lastToken, options.style));
                }
            });
        }
    });
...
//# sourceMappingURL=InterfaceMemberSeparatorRule.js.map